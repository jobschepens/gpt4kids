...
DeveL including - SUBTLEX-Ger - LLM based Frequencies
...
```{r}
# load("../data-processed/devel-LLM_Experiment_2.RData",verbose = T)
# load("../data-processed/devel-LLM_Experiment_1.RData",verbose = T)
# load("../data-processed/devel-LLM_Experiment_1_exp3.RData",verbose = T)
load("../data-processed/devel-LLM_Experiment_1_repr.RData",verbose = T)
# load("data-processed/devel-LLM_Experiment_1.RData",verbose = T)

# results_merged$log_frequency_per_million_j_kids_lo_t_j <- results_merged$log_frequency_per_million_j_kids_lo_t_j # smaller indeed
# results_merged$log_frequency_per_million_j_kids_hi_t_j <- results_merged$log_frequency_per_million_j_kids_hi_t_j # larger indeed
# results_merged$log_frequency_per_million_j_adults_lo_t_j <- results_merged$log_frequency_per_million_ds_lo # like ht
# results_merged$log_frequency_per_million_j_adults_hi_t_j <- results_merged$log_frequency_per_million_ll_lo # like lt, very small
```
