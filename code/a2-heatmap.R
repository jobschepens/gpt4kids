...
library(patchwork)
# patch heatm_devel and heatm in one plot
combined_patchwork <- heatm + heatm_devel+ 
	plot_layout(ncol = 2) +
...
# ggsave(combined_patchwork, filename = "figures/heatmaps.pdf", width = 8, height = 5, dpi = 300)
# ggsave(combined_patchwork, filename = "figures/heatmaps-exp3.pdf", width = 8, height = 5, dpi = 300)
