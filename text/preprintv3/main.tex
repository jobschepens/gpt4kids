...
\begin{figure}[!htbp]
    \centering
    \widefigure{\fullpagewidth}{figures/exp1_ef_size.pdf}
...
\begin{figure}[!htbp]
  %\centering
    \widefigure{\fullpagewidth}{figures/histogram_plot_devel.pdf}
...
\begin{figure}[!htbp]
  %\centering
    ...
    \widefigure{\fullpagewidth}{figures/scatter_plot2_devel.pdf}
...
%     \begin{minipage}[b]{1\textwidth}
    ...
    %\begin{minipage}[t]{0.9\textwidth}
    \widefigure{\fullpagewidth}{figures/scatter_plot_devel.pdf}
...
\begin{figure}[!htbp]
  %\centering
  %\begin{minipage}[t]{0.9\textwidth}
    \widefigure{.7\fullpagewidth}{figures/litkey.pdf}
...
\begin{figure*}[!htbp]
    \widefigure{\fullpagewidth}{figures/rankplot-difs-3.5-2.pdf}
    \widecaption{Differences between word frequency calculated based on the LLM and childLex corpora (i.e., the difference between the curves from Figure \ref{fig:rankplot-normal}).}
...
\begin{figure}[!htbp]
    \centering
    \widefigure{\fullpagewidth}{figures/exp18plus1-log.pdf}
...
\begin{figure}[!htbp]
  %\centering
  %\begin{minipage}[t]{0.9\textwidth}
    \widefigure{.9\fullpagewidth}{figures/correlation_matrix_devel_may.pdf}
...
\begin{table}[!htbp]
\widecaption{Effect size estimates per grade based on the complete set DeveL words.}
\centering
\begin{tabular}{lrrrrr}
  \hline
...
% Mon Aug  5 11:24:23 2024
\begin{table}[!htbp]
\widecaption{Effect size estimates per grade based on a subset of the DeveL data that excludes words with 0 occurrences in the LLM corpus. }
\centering
\begin{tabular}{lrrrrr}
  \hline
 & Estimate & SE & $t$ & $p$ & Adj. $R^2$   \\ 
...
\begin{figure}[!htbp]
    \widefigure{.9\fullpagewidth}{figures/rankf1-exp2.pdf}
    \widecaption{Zipf's law plot showing a stronger negative slope for the LLM corpus compared to childLex. The slopes are fitted to words with a word frequency between 10 and 10,000. }
...
\begin{figure}[!htbp]
    \widefigure{.8\fullpagewidth}{figures/combined_hist_all4-trans.pdf}
    \widecaption{Distributions of word frequency based on childLex and three LLM corpora for all words (left) DeveL words only (right). For clarity, we grouped values with a log frequency per million that was lower than 0.}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/heatmaps.pdf}
...
\begin{figure}[!htbp]
    \widefigure{.8\fullpagewidth}{figures/vgc_plots_grid.pdf}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/scatterplotfacets.pdf}
    \widecaption{Scatterplots between LLM type frequency (y-axis) and childLex type frequency (x-axis; dark gray line) for all four corpora from Experiment 2. The labels show the top five differences on both sides (x-y and y-x). The color gradient of the dots represents the number of data points each dot represents.}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/scatterplotfacetszoom.pdf}
    \widecaption{Zoomed in version of \ref{fig:scatterplotfacets}}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/pos_f.pdf}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/pos_f_devel.pdf}
...
\begin{figure}[!htbp]
    \widefigure{.9\fullpagewidth}{figures/embed100.pdf}
...
\begin{figure}[!htbp]
    \widefigure{.8\fullpagewidth}{figures/vgc_plots_grid_exp3_20.pdf}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/heatmaps-exp3.pdf}
    \caption{Overlap measured as percentage of retrieved words from one of both corpora. Overlap was defined as a word frequency > 0 for both corpora. The overlap percentages were computed by taking the number of words shared between the corresponding corpus listed on the left and bottom and dividing that number by the total corpus size of the corpus listed on the bottom row. Panel A shows percentages for complete corpora while panel B shows overlap for the DeveL selection of words only.}
...
\begin{figure}[!htbp]
    \widefigure{\fullpagewidth}{figures/zipfR_extrapolation.pdf}
